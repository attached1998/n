...
<?php
ob_start();
define('API_KEY','241106362:AAHHX_C7Cj00AoRTAusyqAZGriS5nv6y8lQ');
$admin = "238773538";
...
if (isset($update->edited_message)){
  ...
  $text = "سلام من ربات ادیت نکنم ادمین @mrmt5_bot ایدی اصلیشم @mrmt5 .\nhttps://telegram.me/idrobotshoma?startgroup=new";
  bot('sendmessage',[
    'chat_id'=>$chat_id,
    'text'=>$text,
    'parse_mode'=>'html',
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [
          ['text'=>'terker','url'=>'https://telegram.me/terker']
        ],
        [
          ['text'=>'terker','url'=>'https://telegram.me/terker']
        ]
...
bot('sendMessage',[
      'chat_id'=>$chat_id,
      'text'=>"چطوووووری دادا ادیت کنی من میفهمم "
    ]);
}
